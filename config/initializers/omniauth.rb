...
Rails.configuration.credport_transaction_context_name = 'credport-examplemarketplace-transaction'
Rails.configuration.credport_review_context_name = 'credport-examplemarketplace-review'

Rails.configuration.credport_url_host = 'https://credport-marketplace.herokuapp.com'
